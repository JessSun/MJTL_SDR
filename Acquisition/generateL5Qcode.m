...
% generateL5Qcode.m generates one of the GPS satellite L5Q codes.
%
% L5Qcode = generateL5Qcode(PRN,flag,settings)
%
%   Inputs:
...
%
%   Outputs:
%       L5Icode      - a vector containing the desired L5I code sequence (chips).  
%------------------------------------------------------------------------------------
...
% Initial state of XA register: 1 for 0, and -1 for 1, to perform exclusive OR operation by multiply
xa_reg = ones(1,13) * -1;
