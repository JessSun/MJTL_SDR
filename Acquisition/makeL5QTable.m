...
% Function generates L5Q codes for all 32 satellites based on the settings
% provided in the structure "settings". The codes are digitized at the
% sampling frequency specified in the settings structure.
% One row in the "caCodesTable" is one L5Q code. The row number is the PRN
% number of the L5Q code.
%
% L5QCodesTable = makeCaTable(settings)
%
%   Inputs:
%       PRN             - specified PRN for L5Q code
%       settings        - receiver settings
%   Outputs:
%       makeL5QTable   - an array of arrays (matrix) containing L5I codes
...
% Make the digitized version of the C/A cod
