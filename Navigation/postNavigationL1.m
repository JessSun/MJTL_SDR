function [navSolutions, eph] = postNavigationL1(trackResults, settings)
...
%
%[navSolutions, eph] = postNavigationL1(trackResults, settings)
%
%   Inputs:
...
%% Find satellites positions and clocks corrections =======================
    ...
    [satPositions, satClkCorr] = satpos_L1(transmitTime(activeChnList), [trackResults(activeChnList).PRN], eph); 
...
%% Coordinate conversion ==================================================
        ...
        [navSolutions.latitude(currMeasNr), navSolutions.longitude(currMeasNr), ...
         navSolutions.height(currMeasNr)] = cart2geo(navSolutions.X(currMeasNr), ...
                                            navSolutions.Y(currMeasNr), navSolutions.Z(currMeasNr), 5);
